...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Mod1"    }, "h",      function(c) c:move_to_screen(c.screen.index-1) end ),
    awful.key({ modkey, "Mod1"    }, "l",      function(c) c:move_to_screen(c.screen.index+1) end ),
    awful.key({ modkey, "Mod1"    }, "Left",   function(c) c:move_to_screen(c.screen.index-1) end ),
    awful.key({ modkey, "Mod1"    }, "Right",  function(c) c:move_to_screen(c.screen.index+1) end ),
...
clientbuttons = awful.util.table.join(
    ...
    awful.button({ modkey }, 1, function (c) client.focus = c; c:raise() end),
